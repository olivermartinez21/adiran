...
function initComponents() {
		...
		$("#conditionModel").submit(function () {
			$.ajax({
			type: "POST",
			url: "containerClient/containerValidation",
	...
	$("#newEventModal").submit(function () {
		var data = {
			...
			$.ajax({
			type: "POST",
			url: 'containerClient/saveEventInformation',
			cache: false,
			contentType : "application/x-www-form-urlencoded; charset=UTF-8",
			data:data,
			success: function(response){
...
function addNewEvent(data) {
	...
	validationDate();
	typeZise=document.getElementById("newModel");
...
function configDataTable() {
	$("#containerTable").DataTable({
		...
		buttons: {
			...
			ajax: {
			url: "containerClient/getDataTable",
			type: 'GET',
			dataSrc: '',
	...
	$("#tableResumen").DataTable({
		...
		buttons: {
			...
			ajax: {
			url: "containerClient/getDataResumen",
			type: 'GET',
			dataSrc: '',
		...
		columns: [
			...
			{ data: "disponibles",visible: true },
			{ data: "dañados",visible: true },
			{ data: "ppti",visible: true }, 
			{ data: "total",visible: true }, 
			{ data: "suma",visible: true },
...
function showComponents(data){
	...
	$.ajax({
		type: "GET",
		url: 'containerClient/getComponentIformation',
		contentType : "application/x-www-form-urlencoded; charset=UTF-8",
...
$.ajax({
			type: "GET",
			url: 'containerClient/getSectionInformation',
			contentType : "application/x-www-form-urlencoded; charset=UTF-8",
			data: {containerType : textContainer},
			success: function(response){
...
function getDamageInfotmation(data){
			$.ajax({
		type: "GET",
		url: 'containerClient/getDamageInformation',
		contentType : "application/x-www-form-urlencoded; charset=UTF-8",
...
function showInspections(data) {
	...
	$("#estimateTable").DataTable({
		...
		ajax: {
			url: 'containerClient/getInspections',
			type: 'GET',
			dataSrc: '',
			contentType : "application/x-www-form-urlencoded; charset=UTF-8",
			data: {containerId : data},
