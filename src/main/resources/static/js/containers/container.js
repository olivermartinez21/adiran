...
function dataTableRefresh(){
	...
	$("#tableResumen").DataTable({
		...
		columns: [
			...
			{ data: "tipo",visible: true , render : function(data) {
						$("#newContainerDescription").val(data);
						return $("#newContainerDescription option:selected").html();
					}}, 
...
$.ajax({
			type: "GET",
			url: 'container/getSectionInformation',
			contentType : "application/x-www-form-urlencoded; charset=UTF-8",
			data: {containerType : textContainer},
			success: function(response){
