...
@Slf4j
@Controller
@RequestMapping(UserAdministrationController.HOME)
public class UserAdministrationController extends AbstractMyreController{

	public static final String HOME = PREFIX_ADMIN + "userAdministration";
	...
	public List<UserTableDto> getDataTable() {
		try {
			return userManagementService.getUserTable();
		} catch(Exception ex) {
